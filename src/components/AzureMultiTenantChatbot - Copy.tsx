  ...
  return (
    <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <CardContent className="p-5 text-center">
        <h2 className="text-lg font-semibold">Client Website Widget</h2>
        <p className="text-sm text-gray-600 mt-2">
          Each client embeds <code>widget.js</code> into their website. The widget loads an iframe
          pointing to your hosted chatbot UI, isolated by tenant ID. Visitors interact directly with
          your AI service through this embed.
        </p>
      </CardContent>
      </Card>
      </motion.div>
